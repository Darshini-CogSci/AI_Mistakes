...
To use the code, you would have to download the modified stimuli and helper file for 16-class mapping from https://github.com/rgeirhos/texture-vs-shape.git and add to this directory.
